  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="Ward" component={WardScreen} options={{ title: 'Ward' }} />
        <Stack.Screen name="Connect" component={ConnectScreen} options={{ title: 'Connect' }} />
        <Stack.Screen name="NewSession" component={NewSessionScreen} options={{ title: 'Session' }} />
        <Stack.Screen
          name="Live"
        ...
        />
        <Stack.Screen name="Summary" component={SessionSummaryScreen} options={{ title: 'Summary' }} />
        <Stack.Screen name="Sync" component={SyncQueueScreen} options={{ title: 'Sync' }} />
