  ...
  return (
    <View style={[styles.screen, { backgroundColor: palette.bg }]}>
      ...
      <Text style={[styles.state, { color: palette.text }]}>
        {stateLabelEn(snap.state)}
      </Text>
      <Text style={[styles.guidance, { color: palette.text }]}>
        {guidance(language, snap.state)}
      </Text>

      <Text style={[styles.volume, { color: palette.text }]}>
      ...
      <View style={styles.row}>
        <Metric
          label={copy.rate}
          value={`${Math.round(snap.volumeRateMlPer15min)}`}
          unit="mL"
      ...
      <View style={styles.row}>
        <Metric
          ...
          value={snap.hrBpm == null ? "—" : String(snap.hrBpm)}
          unit="bpm"
          dark={severity === "yellow"}
        />
        <Metric
          label={copy.sbp}
          value={snap.sbpMmhg == null ? "—" : String(snap.sbpMmhg)}
          unit="mmHg"
          dark={severity === "yellow"}
        />
      </View>
      ...
      <Pressable
        ...
        style={styles.mute}
      >
        <Text style={[styles.muteText, { color: palette.text }]}>
          {copy.mute}
        </Text>
      </Pressable>
